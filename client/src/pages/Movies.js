  ...
  return (
    <>
      <DataContext.Provider value={arrays}>
        <div className="bg-gradient-to-t from-gray-200 via-gray-200 to-gray-400 relative z-20">
          ...
          <div className="flex flex-wrap flex-col w-full sm:w-9/12 sm:m-auto pt-32 sm:pt-48 z-10">
            ...
            <div className="flex flex-col items-center xl:items-start">
              <h1 className="w-9/12 text-center xl:text-left mt-12 tracking-wide border-b-2 pb-[2px] font-semibold border-slate-400 md:border-slate-300">
                Oyuncular
              </h1>
            </div>
          ...
          <div className="flex flex-col items-center">
            <h1 className="w-9/12 font-semibold text-center mt-12 tracking-wide border-b-2 pb-[2px] border-slate-400 md:border-slate-300">
              Benzer Filmler
            </h1>
          </div>
