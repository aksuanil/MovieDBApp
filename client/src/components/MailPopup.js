            ...
            <div class="relative p-4 w-full max-w-md h-full md:h-auto ">
                <div class=" bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 pt-0 text-center">
                        <svg class="mx-auto mb-4 w-14 h-14 text-gray-400 dark:text-gray-200" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Mesajınız Gönderildi <br /> Teşekkürler !</h3>
                    </div>
                </div>
            </div>
        </div>
